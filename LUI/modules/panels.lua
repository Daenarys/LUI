...
local Set = function(f, d, p, w, h, s, r, g, b, a, rc, gc, bc, ac)
	...
	if d == "SOLID" then
		...
		f.t:SetGradient("HORIZONTAL", r, g, b, a, r, g, b, a)
		f.b:SetGradient("HORIZONTAL", r, g, b, a, r, g, b, a)
		f.l:SetGradient("VERTICAL", r, g, b, a, r, g, b, a)
		f.r:SetGradient("VERTICAL", r, g, b, a, r, g, b, a)
	elseif d == "LEFT" then
		...
		f.t:SetGradient("HORIZONTAL", r, g, b, a, r, g, b, 0)
		f.b:SetGradient("HORIZONTAL", r, g, b, a, r, g, b, 0)
		f.l:SetGradient("VERTICAL", r, g, b, a, r, g, b, a)
		f.r:SetGradient("VERTICAL", r, g, b, 0, r, g, b, 0)
	elseif d == "TOP" then
		f.c:SetTexture(fdir.."panelbg2.tga")
		f.c:SetVertexColor(rc, gc, bc, ac)
		RotateTexture(f.c, 0)
		...
		f.t:SetGradient("HORIZONTAL", r, g, b, a, r, g, b, a)
		f.b:SetGradient("HORIZONTAL", r, g, b, 0, r, g, b, 0)
		f.l:SetGradient("VERTICAL", r, g, b, 0, r, g, b, a)
		f.r:SetGradient("VERTICAL", r, g, b, 0, r, g, b, a)
	elseif d == "RIGHT" then
		f.c:SetTexture(fdir.."panelbg2.tga")
		f.c:SetVertexColor(rc, gc, bc, ac)
		...
		f.t:SetGradient("HORIZONTAL", r, g, b, 0, r, g, b, a)
		f.b:SetGradient("HORIZONTAL", r, g, b, 0, r, g, b, a)
		f.l:SetGradient("VERTICAL", r, g, b, 0, r, g, b, 0)
		f.r:SetGradient("VERTICAL", r, g, b, a, r, g, b, a)
	elseif d == "BOTTOM" then
		...
		f.t:SetGradient("HORIZONTAL", r, g, b, 0, r, g, b, 0)
		f.b:SetGradient("HORIZONTAL", r, g, b, a, r, g, b, a)
		f.l:SetGradient("VERTICAL", r, g, b, a, r, g, b, 0)
		f.r:SetGradient("VERTICAL", r, g, b, a, r, g, b, 0)
